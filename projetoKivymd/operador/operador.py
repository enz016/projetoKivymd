...
class OperadorWindow(BoxLayout):
    ...
    def update_purschases(self):
        ...
        if pcode == "1234" or pcode == '2345':
            ...
            code = Label(text=pcode, size_hint_x= .2, color=(.2, .2, .7, 1))
            name = Label(text='Product One', size_hint_x= .3, color=(.2, .2, .7, 1))
            qty = Label(text='1', size_hint_x= .1, color=(.2, .2, .7, 1))
            disc = Label(text='0.00', size_hint_x= .1, color=(.2, .2, .7, 1))
            price = Label(text='0.00', size_hint_x= .1, color=(.2, .2, .7, 1))
            total = Label(text='0.00', size_hint_x= .2, color=(.2, .2, .7, 1))
